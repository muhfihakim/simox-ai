...
// 2. AMBIL DATA SERVER FISIK UNTUK OPSI FILTER DROPDOWN
$query_server = "SELECT id, nama_server FROM server_fisik ORDER BY nama_server ASC";
$result_server = $conn->query($query_server);

// 3. QUERY UTAMA: AMBIL SEMUA DATA VM DAN JOIN DENGAN SERVER FISIK
$query_vm = "
    SELECT 
        v.*, 
...
<body class="bg-light">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped align-middle mb-0" id="vmTable">
                        ...
                        <tbody style="font-size: 0.875rem;">
                            ...
                            ?>
                                <tr>
                                    <td colspan="10" class="text-center py-4 text-muted">Belum ada data Virtual Machine di dalam database.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
    ...
    function filterTable() {
        ...
        rows.forEach(row => {
            // Ambil data text dari kolom spesifik di dalam baris
        ...
        // Update teks info jumlah baris yang tampil
