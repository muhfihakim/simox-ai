    ...
    <div class="dashboard ai-fullpage-container">
        ...
        <div class="page-header">
            ...
            <div class="header-actions" style="display: flex; align-items: center; gap: 0.75rem;">
                <div class="api-status checking" id="fullpageAgentStatusBadge" style="padding: 0.4rem 0.75rem; border-radius: 9999px; border: 1px solid var(--border); background: var(--surface);">
        ...
        <div class="ai-fullpage-card">
                ...
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                    ...
                    <div>
                        <div style="font-weight: 600; font-size: 0.95rem; display: flex; align-items: center; gap: 0.5rem;">
                            ...
                            <span class="badge" style="background: rgba(168, 85, 247, 0.15); color: #9333ea; font-size: 0.7rem; border: 1px solid rgba(168, 85, 247, 0.3);">
                                {{ config('services.openclaw.model', 'openclaw') }}
                            </span>
                        </div>
                        <small class="text-muted" style="font-size: 0.75rem;" id="fullpageEndpointInfo">
                            Terhubung ke: {{ config('services.openclaw.base_url', 'http://203.2.151.17:18789') }}
                        </small>
                    </div>
                </div>
                <div style="display: flex; align-items: center; gap: 0.5rem;">
                    <span class="badge" id="fullpageLatencyText" style="background: var(--background); border: 1px solid var(--border); color: var(--text-muted); font-size: 0.75rem;">
            ...
            <div class="ai-fullpage-body" id="fullpageChatBody">
                ...
                <div class="chat-message bot">
                    ...
                    <div class="msg-content">
                        <p style="margin-bottom: 0.5rem;">Halo! Saya <strong>SIMOX AI Agent</strong> ditenagai oleh <strong>OpenClaw</strong>. Saya siap membantu Anda dalam:</p>
                        ...
                        <p style="margin-bottom: 0; font-size: 0.85rem;">Pilih pertanyaan cepat di bawah atau ketik langsung pertanyaan Anda:</p>
                    </div>
                </div>
                ...
                <div class="prompt-chips-container" id="promptChipsContainer">
                    ...
                    <span class="prompt-chip" data-prompt="Tampilkan daftar VM yang saat ini sedang nonaktif atau butuh perhatian.">
                        <i class="ph ph-warning-circle"></i> Cek VM Bermasalah
                    </span>
                    <span class="prompt-chip" data-prompt="Bagaimana rekomendasi alokasi RAM dan CPU agar efisien di Proxmox?">
                        <i class="ph ph-lightbulb"></i> Tips Efisiensi Resource
                    </span>
                    <span class="prompt-chip" data-prompt="Jelaskan cara kerja sinkronisasi data dari Proxmox VE ke SIMOX.">
                        <i class="ph ph-arrows-clockwise"></i> Info Sinkronisasi
                    </span>
                </div>
            </div>
            ...
            <div class="ai-fullpage-input-area">
                <div class="ai-input-wrapper">
                    <textarea id="fullpageChatInput" rows="1" placeholder="Tanyakan sesuatu ke AI Agent... (contoh: Cek pemakaian CPU node 1)" autocomplete="off"></textarea>
                ...
                <div class="ai-input-hint">
                    <span><i class="ph ph-keyboard"></i> Tekan <strong>Enter</strong> untuk mengirim, <strong>Shift + Enter</strong> untuk baris baru.</span>
                    <span><i class="ph ph-shield-check"></i> Sesi terisolasi &middot; SIMOX Proxmox Assistant</span>
                </div>
            </div>
        </div>
    </div>
