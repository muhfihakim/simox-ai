...
<head>
    ...
    <title>Pulihkan Akses - SIMOX AI</title>
    <link
...
<body>
    ...
    <div class="card-wrapper">
        ...
        <div class="header-text">
            ...
            <p>Masukkan alamat email admin terdaftar untuk menerima tautan pemulihan kata sandi.</p>
        </div>

        @if (session('status'))
            <div class="alert-box-success">
                <i class="ph-fill ph-check-circle" style="font-size: 1.2rem; flex-shrink: 0;"></i>
        ...
        <form action="{{ route('password.email') }}" method="POST">
            ...
            <button type="submit" class="btn-submit">
                <span>Kirim Tautan Pemulihan</span> <i class="ph-bold ph-paper-plane-right"></i>
            </button>

            <div style="text-align: center;">
                <a href="{{ route('login') }}" class="back-link">
                    <i class="ph ph-arrow-left"></i> Kembali ke Halaman Login
                </a>
            </div>
        </form>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (form && submitBtn) {
                form.addEventListener('submit', function() {
                    ...
                    submitBtn.innerHTML = '<i class="ph ph-spinner ph-spin" style="font-size: 1.15rem;"></i> <span>Mengirim Tautan Pemulihan...</span>';
                });
            }
        });
    </script>
